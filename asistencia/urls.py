...
from .views import RegistroUsuarioView, ListarUsuariosView, EliminarUsuarioView, CursoRegistroView, ListarCursosView, EliminarCursoView, MateriaRegistroView,ListarMateriasView,EliminarMateriasView,AsistenciaRegistroView,ListarAsistenciasView, HorarioRegistroView, ListasHorarioView, EliminarHorarioView
